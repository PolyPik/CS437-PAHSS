...
public class EquipmentMonitorGui {
	ArrayList<EquipmentCheckGui> EquipmentCheckGuiList = new ArrayList<EquipmentCheckGui>();

	public ArrayList<EquipmentCheckGui> getCheckList() {
		return EquipmentCheckGuiList;
	}

	// replaces monitor.getCheckList.get(i);
	public EquipmentCheckGui getCheckListValue(int i) {
		return EquipmentCheckGuiList.get(i);
	}

	// replaces monitor.getCheckList.add(i);
	public void addToCheckList(EquipmentCheckGui e) {
		EquipmentCheckGuiList.add(e);
	}
}

class EquipmentCheckGui extends Thread {
	...
	EquipmentCheckGui(int tank_id, int equipment_id) {
	...
	public static void main(String[] args) {
		...
		/*
		 * The EquipmentMonitorGui class has an ArrayList EquipmentCheckGuiList. The
		 * main method of EquipmenentCheck will create an object of type
		 * EquipmentMonitorGui, and proceed to add elements to it of type
		 * EquipmentCheckGui. When we implement the database, these objects will
		 ...
		 */
		EquipmentMonitorGui monitor = new EquipmentMonitorGui();
		...
		for (int t = 1; t <= numberOfTanks; t++) {
			for (int e = 1; e <= 19; e++)
				monitor.addToCheckList(new EquipmentCheckGui(t, e));
		}
		 ...
		 * tank_id and equipment_id to create a new EquipmentCheckGui object and
